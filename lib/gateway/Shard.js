...
class Shard extends EventEmitter {
    ...
    */
    ...
    onWSMessage(packet) {
        ...
        if (packet.op !== 0 && packet.op !== 1) {
            const readableOp = Object.keys(OPCodes).find(k => OPCodes[k] === packet.op);
            this.emit("debug", `Received packet with opcode ${packet.op} (${readableOp})`);
        }
